...
//    console.log(signupPage);
    ...
    agreeToTermslabel.addEventListener('click', function(event) {
                                   ...
                                   var agreeToTermsLink = window.open('http://www.myavana.com/terms', '_blank', 'EnableViewPortScale=yes');
...
//    alert(deviceVersion);
    ...
    function twitterConnectShare(buttonIndex) {
        if (buttonIndex == 1) {
            ...
            var postHeadingString = "Go check out my hairstyles on Myavana and download the app today! http://bit.ly/MyavanaApp";
...
//                window.socialmessage.send(HLcaption, ["PostToTwitter", "PostToFacebook"]);
                window.socialmessage.send("Go check out my hairstyles on Myavana and download the app today! http://bit.ly/MyavanaApp"+" "+"https://si0.twimg.com/profile_images/3414601530/916ba4bc079482c2b2f74911068374f9.png", ["PostToFacebook"]);
...
//                                  myOptionsFacebookIndex = 1;
                                    ...
                                    window.socialmessage.send("Go check out my hairstyles on Myavana and download the app today! http://bit.ly/MyavanaApp", ["PostToFacebook"]);
...
//                                       myOptionsTwitterIndex = 1;
                                      ...
                                      window.socialmessage.send("Go check out my hairstyles on Myavana and download the app today! http://bit.ly/MyavanaApp", ["PostToTwitter"]);
...
//                                                                     );
    ...
    myOptionsBlog.addEventListener('click', function(event) {
                                   ...
                                   var myBlog = window.open('http://www.myavana.com/tutorial', '_blank', 'EnableViewPortScale=yes');
    ...
    myOptionsTerms.addEventListener('click', function(event) {
                                    ...
                                    var myTerms = window.open('http://www.myavana.com/terms', '_blank', 'EnableViewPortScale=yes');
    ...
    myOptionsPrivacy.addEventListener('click', function(event) {
                                      ...
                                      var myPrivacy = window.open('http://www.myavana.com/privacy', '_blank', 'EnableViewPortScale=yes');
    ...
    function submitFeedback(input) {
        ...
        if ( (input != "") && (input.length > 8) ) {
            ...
            navigator.notification.alert('You must enter at least 8 characters to submit feedback.',leavePrefUpdateBtnDivIndex = 0, 'Myavana', 'OK');
        }
...
//                               profFbImgIndex = 1;
                            ...
                            var postHeadingString = "Check out this hairstyle I found on Myavana! Download the app here:";
                               var appLink = "http://bit.ly/MyavanaApp";
                               
                            window.socialmessage.send(postHeadingString+" "+appLink, ["PostToFacebook"]);
...
//                                    profTwitterImgIndex = 1;
                                    ...
                                    var postHeadingString = "Check out this hairstyle I found on Myavana! Download the app here:";
                                    var appLink = "http://bit.ly/MyavanaApp";
                                    window.socialmessage.send(postHeadingString+" "+appLink, ["PostToTwitter"]);
...
//                                                                   );
    ...
    function twitterPhotoShare(buttonIndex) {
        if (buttonIndex == 1) {
            ...
            TwitterDemo.isSetup2(postHeadingString,appLink);
...
function editProfileActions() {
    ...
    if (userArray.stylist == true) {
        ...
        '<input type="text" id="editStylistSalonAddress" class="editProfileInput" maxlength="60" placeholder="Salon Address"/>'+
...
function viewLargePhoto(photoURL,caption,mediaid,likes,datecreated,profUserName,totalcomments) {
    ...
    function facebookPhotoShare(buttonIndex) {
        if (buttonIndex == 1) {
            ...
            var postHeadingString = "Check out this look I found on Myavana! ";
            var appLink = "http://bit.ly/MyavanaApp";
            checkFBLoginStatus(postHeadingString,appLink);
